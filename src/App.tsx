...
function App() {
  ...
  const [savePreviewDataUrl, setSavePreviewDataUrl] = useState<string | null>(null);
  ...
  const collageSlots = useMemo(
    ...
    [collageDividersEnabled, collageLayout, collageSpacing, stageSize.height, stageSize.width],
  );
  ...
  const handleApplyFormatPicker = () => {
    ...
    const nextDividersEnabled = collageDividersEnabled;
    ...
    const shouldRemapCollage =
      ...
      (
        ...
        nextSpacing !== collageSpacing ||
        nextDividersEnabled !== collageDividersEnabled
      );
    ...
    setCollageDividersEnabled(nextDividersEnabled);
    dismissSelectionUi();
    setIsFormatPickerOpen(false);
  };
  ...
  const handleToggleCollageDividers = (enabled: boolean) => {
    ...
    setCollageDividersEnabled(enabled);
  };
      ...
      <main className="workbench" onPointerDown={handleWorkbenchPointerDown}>
        ...
        >
          ...
          <EditorCanvas
            ...
            isSavePreviewOpen={Boolean(savePreviewDataUrl)}
        ...
        <div className="save-preview" role="dialog" aria-modal="true" aria-label="Сохранение изображения">
          ...
          <div className="save-preview-card">
            <p className="save-preview-copy">
              Удерживай изображение и выбирай «Сохранить в Фото» в меню iPhone.
            </p>
            <img
